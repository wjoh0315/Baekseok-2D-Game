...
namespace UltimateCC
{
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (isPlayer1)
            {
                playerControls.Player.Jump2.started += OnJumpStarted;
                playerControls.Player.Jump2.canceled += OnJumpCanceled;
                playerControls.Player.Walk2.performed += OnWalk;
                playerControls.Player.Walk2.canceled += OnWalk;
                return;
            }
